...
// This is the first version of the kernel I wrote
// The major difference is that it uses BM=BN=128, BK=8, TM=TN=8 and is less flexible/tunable than the above version.
// I mostly just had claude make the newer version more flexible and tunable, but given the same tunables, there was no significant difference in performance
// I left this here in case it's helpful for understanding the more flexible version above, but you can ignore it if you want.
